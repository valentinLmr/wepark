...
g.save!
g = Garage.create!(user: first_user, capacity: 6, price: 30, location: "18 rue mouscron 59170", city: 'Lille', description: "Magnifique Garage éclairé avec fenetere")
g.remote_photo_url = "https://www.degarageamersfoort.nl/userfiles/images/mbo_garage_bg_1.jpg"
g.save!
g = Garage.create!(user: last_user, capacity: 7, price: 30, location: "99 rue kleber 45876", city: 'Mouvaux', description: "Petit Garage plein nord")
g.remote_photo_url = "https://www.ctm-renovation.fr/wp-content/uploads/2016/04/construire-un-garage.jpg"
g.save!
g = Garage.create!(user: last_user, capacity: 6, price: 10, location: "98 rue kleber 09876", city: 'Paris', description: "Magnifique Garage plein sud")
g.remote_photo_url = "https://www.steeltechsheds.ie/wp-content/gallery/garages-2017/26ft-x-17ft-garage.jpg"
g.save!
g = Garage.create!(user: first_user, capacity: 10, price: 100, location: "28 rue kleber 65432", city: 'Nice', description: "Nouveau Garage en brique rouge")
g.remote_photo_url = "https://www.sgauto-16.fr/userfiles/7066/garage-SG-Auto.jpg"
g.save!
g = Garage.create!(user: last_user, capacity: 12, price: 20, location: "108 rue kleber 59170", city: 'Anjou', description: "Toujours un Garage mal exposé")
g.remote_photo_url = "https://www.ctm-renovation.fr/wp-content/uploads/2016/04/construire-un-garage.jpg"
g.save!
g = Garage.create!(user: first_user, capacity: 8, price: 30, location: "3248 rue kleber 75000", city: 'Lomme', description: "Encore un Garage bien isolé")
g.remote_photo_url = "https://www.degarageamersfoort.nl/userfiles/images/mbo_garage_bg_1.jpg"
g.save!
